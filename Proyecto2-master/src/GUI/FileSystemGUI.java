...
public class FileSystemGUI extends JFrame {
    ...
    public FileSystemGUI() {
        ...
        processPanel.setBorder(BorderFactory.createTitledBorder("⚙️ Cola de Procesos"));
    ...
    private void procesarCola() {
        if (fileSystem.getProcessQueue().isEmpty()) {
            JOptionPane.showMessageDialog(this, "⚠️ No hay procesos en la cola.", "Cola vacía", JOptionPane.WARNING_MESSAGE);
            return;
        }
        ...
        Thread processThread = new Thread(() -> {
            ...
            SwingUtilities.invokeLater(() -> {
                ...
                JOptionPane.showMessageDialog(this, "✅ Todos los procesos han sido ejecutados.", 
    ...
    private void crearArchivo() { 
        ...
        JOptionPane.showMessageDialog(this, "✅ Proceso creado. Use 'Procesar Cola' para ejecutar.", 
    ...
    private void eliminarArchivo() { 
        ...
        JOptionPane.showMessageDialog(this, "✅ Proceso de eliminación creado.", "En cola", JOptionPane.INFORMATION_MESSAGE);
        actualizarInterfaz();
    }
    ...
    private void actualizarArchivo() { 
        ...
        JOptionPane.showMessageDialog(this, "✅ Proceso de actualización creado.", "En cola", JOptionPane.INFORMATION_MESSAGE);
    }
